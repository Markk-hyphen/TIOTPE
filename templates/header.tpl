...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="nav-link border-bottom border-primary border-3 px-3 ms-1  display-4" href="home">Home</a>
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav d-flex flex-row justify-content-between">
        <a class="nav-link border-bottom border-primary border-3 px-3 ms-1 display-7" href="autos">Autos</a> 
        ...
        <a class="nav-link border-bottom border-primary border-3 px-3 ms-1 display-7" href="#">Seccion Gaspar</a>
      </div>
